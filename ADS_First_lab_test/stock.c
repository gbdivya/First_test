...
Queue* queue_add(Queue *q, Stock, Result *res){​​​​​​​
    assert( q != NULL );
    if ( q->count < q->size ){​​​​​​​
        q->data[q->rear] = share;
...
Queue* queue_add_share(Queue *q, Stock, Result *res)
{​​​​​​​
if(q->count==Q_LEN)
{​​​​​​​
...
Queue* topup(Queue* q,Stock,int quantity)
{​​​​​​​
assert(q!=NULL);
for(i=q->front;i<=Q_LEN;i++)
{​​​​​​​
